...
#Llama a getAllImagesTransport() para obtener todas las imágenes de la API.
#Convierte cada imagen en una Card usando fromRequestIntoCardTranslator(personaje).
#Si el personaje tiene nombres alternativos, elige uno al azar con random.choice().
#Si el personaje tiene nombres alternativos, elige uno al azar con random.choice().
def getAllImages():
